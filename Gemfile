...
# File Handling
gem "rubyzip" # Handle zipped content files from Drupal
...
gem "namae" # Name parsing
gem "mods_display" # Generate HTML from MODS
...
group :development do
  ...
  # Opens sent emails in the browser instead of delivering them
  gem "letter_opener"
end
