  ...
  describe '#store' do
    context 'with valid core_file' do
      ...
      it 'includes collection IDs as comma-separated string' do
        ...
        # Verify the stub was called (params are included in the stub)
        expect(WebMock).to have_requested(:post, /tapas-xq/)
      end

      it 'formats is-public parameter as string' do
      ...
      it 'handles empty authors and contributors' do
        ...
        expect(result[:mods_xml]).to be_present
      end
    end
